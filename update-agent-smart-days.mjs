...
async function updateSystemPrompt() {
  ...
  if (calendarStart === -1) {
    ...
    console.log('📝 Found existing CALENDAR BOOKING section, replacing...\n');
  ...
  console.log('  📅 Test on Friday → Agent suggests "Monday"');
  console.log('  📅 Test with fully booked day → Agent skips to next available');
  console.log('  📅 Mon-Thu → Agent checks availability first');
  console.log('');
