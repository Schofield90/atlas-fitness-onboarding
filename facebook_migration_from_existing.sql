-- Migration to extend existing facebook_integrations table and add new tables

-- Enable UUID extension if not already enabled
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Add missing columns to existing facebook_integrations table
...
-- Migrate existing data: Use page_id as facebook_user_id if needed
...
-- Migrate existing page data from facebook_integrations to facebook_pages
...
ON CONFLICT (organization_id, facebook_page_id) DO NOTHING;
...
-- Policies for facebook_lead_forms
...
-- Policies for facebook_webhooks
...
-- Policies for facebook_ad_accounts
...
-- Policies for facebook_campaigns
