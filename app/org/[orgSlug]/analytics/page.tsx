        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-blue-200 text-sm mb-3">
              Advanced analytics features are in development. The data shown
            ...
            <button
              onClick={() => {
                ...
                toast.className =
                  "fixed top-4 right-4 z-50 px-6 py-4 rounded-lg shadow-lg bg-blue-600 text-white";
                toast.innerHTML = `
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <div className="mt-2 flex items-center text-sm">
            ...
            <span className="text-green-500">
              +{analyticsData.trends.memberGrowth}%
            </span>
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <div className="mt-2 flex items-center text-sm">
            ...
            <span className="text-green-500">
              {analyticsData.trends.retentionRate}%
            </span>
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">
                {analyticsData.overview.classAttendance}
              </p>
            </div>
