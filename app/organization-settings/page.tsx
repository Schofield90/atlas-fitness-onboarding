...
import { Save, Plus, Trash2, Phone, Mail, MessageSquare, Bot } from 'lucide-react'
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          {activeTab === 'general' && settings && (
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Default Greeting</label>
                <input
                  type="text"
                ...
                />
                <p className="text-xs text-gray-400 mt-1">What callers hear when they call your number</p>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Email Reply-To</label>
                <input
                  type="email"
          ...
          {activeTab === 'voice' && settings && (
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Call Routing Type</label>
                <select
                  value={settings.call_routing_type}
                  onChange={(e) => setSettings({...settings, call_routing_type: e.target.value})}
                  className="w-full px-4 py-2 bg-gray-700 rounded-lg"
                >
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Call Timeout (seconds)</label>
                <input
                  type="number"
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) => setSettings({...settings, record_calls: e.target.checked})}
              ...
              {settings.voicemail_enabled && (
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setSettings({...settings, voicemail_message: e.target.value})}
          ...
          {activeTab === 'messaging' && settings && (
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">SMS Signature</label>
                <input
                  type="text"
                  value={settings.sms_signature || ''}
                  onChange={(e) => setSettings({...settings, sms_signature: e.target.value})}
                  className="w-full px-4 py-2 bg-gray-700 rounded-lg"
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) => setSettings({...settings, whatsapp_business_hours_only: e.target.checked})}
                  className="w-4 h-4 text-orange-600"
                />
                <label htmlFor="whatsapp_hours">Only respond to WhatsApp during business hours</label>
              </div>
            </div>
          )}
                ...
                <>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setSettings({...settings, ai_response_style: e.target.value})}
                      className="w-full px-4 py-2 bg-gray-700 rounded-lg"
                    >
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div className="flex gap-4 mt-2 text-xs">
                          ...
                          <span className={member.receives_sms ? 'text-green-400' : 'text-gray-500'}>
                            {member.receives_sms ? '✓' : '✗'} SMS
                          </span>
                          <span className={member.receives_whatsapp ? 'text-green-400' : 'text-gray-500'}>
                            {member.receives_whatsapp ? '✓' : '✗'} WhatsApp
                          </span>
                          <span className={member.receives_emails ? 'text-green-400' : 'text-gray-500'}>
