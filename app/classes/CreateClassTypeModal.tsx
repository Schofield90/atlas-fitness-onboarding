...
export default function CreateClassTypeModal({ onClose, onSuccess }: CreateClassTypeModalProps) {
    ...
    try {
      ...
      const { data: classType, error: insertError } = await supabase
        ...
        .insert({
          ...
          max_participants: formData.default_capacity ? parseInt(formData.default_capacity) : null,
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Describe the Class Type. You can format the text in this box.</p>
          </div>
            ...
            <div className="space-y-2">
              <label className="flex items-center">
                ...
                <span className="text-white">
                  Default Timeline - Calendar opens to <strong>everyone {formData.registration_window_days} days before event</strong>. 
                  Registrations between <strong>365 days before event starts</strong> and <strong>when event starts</strong>. 
                  Cancels up to <strong>1 minute before event starts</strong>.
                </span>
              </label>
            </div>
          </div>
            ...
            <div className="space-y-2">
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, allow_drop_ins: e.target.value })}
                  className="mr-2"
                />
                <span className="text-white">No, registrations are only allowed when included in a membership.</span>
              </label>
              <label className="flex items-center">
                <input
                  type="radio"
            ...
            <div className="space-y-2">
              <label className="flex items-center">
                <input
                  ...
                  className="mr-2"
                />
                <span className="text-white">No, all ages are able to register</span>
              </label>
              <label className="flex items-center">
                <input
                  type="radio"
