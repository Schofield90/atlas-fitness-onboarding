      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-400 mb-6">
            Thank you, {waiverData.customer.name}. Your waiver has been signed
            and submitted.
          </p>
          <div className="bg-gray-800 rounded-lg p-4 text-left">
            <h3 className="font-semibold text-white mb-2">
              {waiverData.waiver.title}
            </h3>
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <span className="ml-2 text-white">
                {waiverData.customer.name}
              </span>
            </div>
            <div>
              <span className="text-gray-400">Email:</span>
              <span className="ml-2 text-white">
                {waiverData.customer.email}
              </span>
            </div>
            <div>
              <span className="text-gray-400">Waiver Type:</span>
              <span className="ml-2 text-white">
                {waiverData.waiver.waiver_type
                  .replace(/_/g, " ")
            ...
            {waiverData.expires_at && (
              <div>
                ...
                <span className="ml-2 text-white">
                  {formatBritishDate(waiverData.expires_at)}
                </span>
              </div>
            )}
          </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 mb-6">
          ...
          <p className="text-gray-400 mb-4">
            ...
            and agree to the terms of this waiver.
          </p>
        ...
        {waiverData.waiver.requires_witness && (
          <div className="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <p className="text-gray-400 mb-4">
              This waiver requires a witness signature. Please have a witness
              provide their information and signature.
            </p>
                ...
                <div className="mt-1">
                  {witnessName.trim() && hasWitnessSignature ? (
                    <span className="text-green-400">
                      ✓ Witness signature provided
                    </span>
                  ) : (
                    <span>
                      Please provide witness information and signature
                    </span>
                  )}
                </div>
              )}
