      ...
      case "permissions":
        return (
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <p className="text-gray-400">
              Manage user roles, permissions, and access controls across the
              platform.
            </p>
          </div>
        );
      case "api":
        return (
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <p className="text-gray-400">
              Configure API keys, rate limiting, and access controls for
      ...
      case "monitoring":
        return (
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <p className="text-gray-400">
              Monitor security events, configure alerts, and review access
              patterns.
            </p>
          </div>
        );
