        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-md">
              <h3 className="text-lg font-medium text-blue-900 mb-4">Additional Employee Details</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="nationalInsuranceNumber" className="block text-sm font-medium text-gray-700">
            ...
            <div className="bg-green-50 p-4 rounded-md">
              <h3 className="text-lg font-medium text-green-900 mb-4">Bank Details for Payment</h3>
