...
export async function PATCH(request: NextRequest) {
  try {
    ...
    if (body.slotDuration !== undefined) updateData.slot_duration = body.slotDuration
    if (body.bufferTime !== undefined) updateData.buffer_time = body.bufferTime
    if (body.timezone !== undefined) updateData.timezone = body.timezone
    if (body.googleCalendarConnected !== undefined) updateData.google_calendar_connected = body.googleCalendarConnected
    if (body.bookingConfirmationEnabled !== undefined) updateData.booking_confirmation_enabled = body.bookingConfirmationEnabled
