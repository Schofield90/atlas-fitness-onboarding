  ...
  try {
    ...
    switch (action) {
      case 'add_employees':
        ...
        await payrollService.addEmployeesToBatch(params.id, updateData.employeeIds);
        break;
      ...
      case 'approve':
        ...
        await payrollService.approveBatch(params.id, updateData.userId, updateData.notes);
        break;
      ...
      case 'reject':
        ...
        await payrollService.rejectBatch(params.id, updateData.userId, updateData.reason);
        break;
