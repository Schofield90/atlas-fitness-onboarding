...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Facebook integration has been reset. You can now reconnect your account.',
      actions: [
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!status.hasIntegration) {
      ...
      recommendation = 'Please reconnect your Facebook account to refresh the token'
