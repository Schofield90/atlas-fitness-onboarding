...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const redirectUri = process.env.META_OAUTH_REDIRECT_URI || `${process.env.NEXT_PUBLIC_URL}/api/integrations/meta/callback`
    const userAccessToken = await MetaMessengerClient.exchangeCodeForToken(code, redirectUri)
