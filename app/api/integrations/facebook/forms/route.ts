  ...
  try {
    ...
    const transformedForms =
      forms?.map((form) => ({
        ...
        name: form.form_name,
        pageId: Array.isArray(form.facebook_pages)
          ? (form.facebook_pages[0] as any)?.facebook_page_id
          : (form.facebook_pages as any)?.facebook_page_id,
        pageName: Array.isArray(form.facebook_pages)
          ? (form.facebook_pages[0] as any)?.page_name
          : (form.facebook_pages as any)?.page_name,
