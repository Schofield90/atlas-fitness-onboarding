...
export async function GET(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to fetch customer waiver' }, { status: 500 })
    }
...
export async function PUT(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to update customer waiver' }, { status: 500 })
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to cancel customer waiver' }, { status: 500 })
    }
