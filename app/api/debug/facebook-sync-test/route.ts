...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      suggestions: [
        apiError && 'Check if your Facebook app has the correct permissions (pages_show_list, pages_read_engagement)',
        apiError?.code === 190 && 'Access token may be expired - try reconnecting Facebook',
        pages.length === 0 && !apiError && 'No pages found - ensure you have admin access to at least one Facebook page',
