...
export async function GET(request: Request) {
  try {
    ...
    const { data: customerMemberships, error: cmError } = await supabase
      ...
      .or(`customer_id.eq.${customerId},customer_id.eq.1c7255f6-ba26-4258-8693-379ce97732ed,customer_id.eq.9433c71d-2c3f-4d99-b254-68ae5b56978a`);
    ...
    results.bookingTableStructure = bookingColumns?.[0] ? Object.keys(bookingColumns[0]) : 'No bookings';
