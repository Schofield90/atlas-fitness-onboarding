...
export async function POST(
  ...
  try {
    ...
    const slotEnd = new Date(slotStart.getTime() + policy.duration_mins * 60000);
    ...
    try {
      ...
      const { data: existingBookings } = await supabase
        ...
        .gte('start_time', new Date(slotStart.getTime() - 24 * 3600000).toISOString())
        .lte('start_time', new Date(slotStart.getTime() + 24 * 3600000).toISOString())
