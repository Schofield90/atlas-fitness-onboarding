...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error("Error in class-sessions-bypass API:", error);
    return NextResponse.json(
      {
...
// Create a new class session using service role
  ...
  try {
    ...
    const { data: newSession, error } = await supabase
      ...
      .insert({
        ...
        created_by: "ea1fc8e3-35a2-4c59-80af-5fde557391a1", // Sam's ID
      })
      .select()
      .single();
    ...
    console.error("Error in POST class-sessions-bypass:", error);
    return NextResponse.json(
      {
        error: "Internal server error",
        details: error instanceof Error ? error.message : "Unknown error",
...
// Update a class session using service role
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error("Error in PUT class-sessions-bypass:", error);
    return NextResponse.json(
      {
        error: "Internal server error",
        details: error instanceof Error ? error.message : "Unknown error",
...
// Delete a class session using service role
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error("Error in DELETE class-sessions-bypass:", error);
    return NextResponse.json(
      {
        error: "Internal server error",
        details: error instanceof Error ? error.message : "Unknown error",
