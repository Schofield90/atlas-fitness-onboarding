...
export class SearchClientsTool extends BaseTool {
  ...
  name = "Search Clients";
  description =
    "Search for clients/members by name, email, or phone number. Returns basic profile information with membership details.";
...
export class ViewClientProfileTool extends BaseTool {
  ...
  description =
    "Get comprehensive profile information for a specific client including personal details, membership tier, and metadata.";
  category = "crm" as const;
...
export class ViewClientBookingsTool extends BaseTool {
  ...
  description =
    "Get booking history for a specific client including past and upcoming sessions with attendance tracking.";
  category = "crm" as const;
  ...
  parametersSchema = z.object({
    ...
    status: z
      .enum(["booked", "cancelled", "attended", "no_show", "all"])
      .optional()
      .default("all")
...
export class ViewClientPaymentsTool extends BaseTool {
  ...
  description =
    "Get payment history for a specific client including successful and failed transactions.";
  category = "crm" as const;
  ...
  async execute(
    ...
    try {
      ...
      // Calculate summary
      const totalAmount =
        data?.reduce((sum: number, p: any) => sum + (p.amount_cents || 0), 0) ||
        0;
...
export class UpdateClientStatusTool extends BaseTool {
  ...
  description =
    "Update the status of a client (active/inactive). Use for marking clients as inactive when they cancel membership.";
  category = "crm" as const;
  ...
  parametersSchema = z.object({
    ...
    status: z
      ...
      .describe("New status for the client"),
    reason: z
      .string()
      .optional()
      .describe("Reason for status change (stored in metadata)"),
  });
...
export class SearchLeadsTool extends BaseTool {
  ...
  name = "Search Leads";
  description =
    "Search for leads by name, email, phone, or source. Filter by status and score.";
  category = "crm" as const;
  ...
  parametersSchema = z.object({
    query: z
      .string()
      .optional()
      .describe("Search query for name, email, or phone"),
    status: z
      .enum(["new", "contacted", "qualified", "converted", "lost", "all"])
      .optional()
      .default("all")
      .describe("Lead status filter"),
...
export class ViewLeadProfileTool extends BaseTool {
  ...
  description =
    "Get detailed information for a specific lead including contact details, score, and conversion status.";
  category = "crm" as const;
...
export class UpdateLeadStatusTool extends BaseTool {
  ...
  description =
    "Update the status of a lead in the sales pipeline. Track progression from new to converted or lost.";
  category = "crm" as const;
...
export class SearchClassesTool extends BaseTool {
  ...
  name = "Search Classes";
  description =
    "Search for class types/programs by name or category. Returns class definitions, not scheduled sessions.";
  ...
  parametersSchema = z.object({
    query: z
      .string()
      .optional()
      .describe("Search query for class name or description"),
...
export class ViewClassScheduleTool extends BaseTool {
  ...
  description =
    "Get upcoming class sessions with instructor and booking information. Filter by date range and class type.";
  category = "data" as const;
  ...
  parametersSchema = z.object({
    classId: z
      ...
      .uuid()
      .optional()
      .describe("Filter by specific class ID"),
    startDate: z
      .string()
      .optional()
...
export class CheckClassAvailabilityTool extends BaseTool {
  ...
  description =
    "Check available spots for a specific class session. Returns current bookings vs capacity.";
  category = "data" as const;
...
export class ViewClassBookingsTool extends BaseTool {
  ...
  description =
    "Get all bookings for a specific class session with client details.";
  category = "data" as const;
  ...
  parametersSchema = z.object({
    ...
    includeWaitlist: z
      ...
      .optional()
      .default(false)
      .describe("Include waitlisted bookings"),
  });
...
export class QueryPaymentsTool extends BaseTool {
  ...
  name = "Query Payments";
  description =
    "Query payment/subscription records with various filters. Useful for financial analysis and reporting.";
  category = "data" as const;
  ...
  parametersSchema = z.object({
    clientId: z
      ...
      .uuid()
      .optional()
      .describe("Filter by specific client"),
...
export class QuerySubscriptionsTool extends BaseTool {
  ...
  description =
    "Query active and historical subscriptions with plan details. Filter by status and date range.";
  category = "data" as const;
...
export class CalculateEngagementScoreTool extends BaseTool {
  ...
  description =
    "Calculate engagement score for a member based on attendance, bookings, and activity. Returns score 0-100.";
  ...
  async execute(
    ...
    try {
      ...
      const startDate = new Date(
        endDate.getTime() - validated.periodDays * 24 * 60 * 60 * 1000,
      );
      ...
      const bookingFrequencyScore = Math.min(
        100,
        (totalBookings / expectedBookingsPerPeriod) * 100,
      );
