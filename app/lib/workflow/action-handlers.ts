...
export class ActionHandlerRegistry {
  ...
  private registerHandlers(): void {
    ...
    this.handlers.set(
      ...
      this.handleMultiChannelMessage.bind(this),
    );
    ...
    this.handlers.set(
      "update_lead_score",
      this.handleUpdateLeadScore.bind(this),
    );
    ...
    this.handlers.set(
      ...
      this.handleSendBookingReminder.bind(this),
    );
    ...
    this.handlers.set(
      ...
      this.handleAIAnalyzeConversation.bind(this),
    );
    this.handlers.set(
      "ai_generate_response",
      this.handleAIGenerateResponse.bind(this),
    );
    this.handlers.set(
      "ai_sentiment_analysis",
      this.handleAISentimentAnalysis.bind(this),
    );
    ...
    this.handlers.set(
      "conditional_branch",
      this.handleConditionalBranch.bind(this),
    );
    ...
    this.handlers.set(
      ...
      this.handleRemoveFromSequence.bind(this),
    );
    ...
    this.handlers.set(
      "send_slack_message",
      this.handleSendSlackMessage.bind(this),
    );
  }
  ...
  private async handleSendEmail(
    ...
    // Resolve recipient
    const recipient =
      this.interpolateVariables(to, context) ||
    ...
    const emailSubject = this.interpolateVariables(
    ...
    if (templateId) {
      ...
      if (template) {
        ...
        emailBody = this.interpolateVariables(
          customMessage || "Default email content",
          context,
        );
      }
    } else {
      emailBody = this.interpolateVariables(
        body || customMessage || "Default email content",
        context,
      );
    }
  ...
  private async handleSendSMS(
    ...
    if (templateId) {
      ...
      smsMessage = template
        ? this.interpolateVariables(template.content, context)
        : message;
    } else {
  ...
  private async handleSendWhatsApp(
    ...
    try {
      const result = await sendWhatsApp({
        ...
        mediaUrl: mediaUrl
          ? this.interpolateVariables(mediaUrl, context)
          : undefined,
        organizationId: context.userContext?.organizationId,
      });
  ...
  private async handleMultiChannelMessage(
    ...
    const channelsToTry = fallbackOrder ||
  ...
  private async handleUpdateLead(
    ...
    const targetLeadId =
      this.interpolateVariables(leadId, context) ||
  ...
  private async handleCreateTask(
    ...
    const taskData = {
      ...
      related_id:
        this.interpolateVariables(relatedTo?.id, context) ||
        context.variables._executionId,
      status: "pending",
  ...
  private async handleAddTag(
    ...
    const entityId =
      this.interpolateVariables(targetId, context) ||
      context.variables.lead?.id ||
      context.variables.leadId;
  ...
  private async handleWebhook(
    ...
    const config = node.data.config || {};
    const { url, method, headers, body, timeout, retries } = config;
   ...
   */
  private interpolateVariablesInObject(
    obj: any,
    context: ExecutionContext,
  ): any {
    ...
    if (Array.isArray(obj)) {
      return obj.map((item) =>
        this.interpolateVariablesInObject(item, context),
      );
    }
  ...
  private async handleAssignLead(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleUpdateLeadScore(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleSendBookingReminder(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleAIAnalyzeConversation(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleAIGenerateResponse(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleAISentimentAnalysis(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleTransformData(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleValidateData(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleEnrichLeadData(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleConditionalBranch(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleLoopControl(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleAddToSequence(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleRemoveFromSequence(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
  ...
  private async handleSendSlackMessage(
    node: WorkflowNode,
    context: ExecutionContext,
  ): Promise<ActionResult> {
