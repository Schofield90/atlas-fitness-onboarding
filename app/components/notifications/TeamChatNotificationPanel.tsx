...
import { Bell, BellOff, X, Hash, AtSign, UserPlus, CheckCircle, Circle } from 'lucide-react';
...
export default function TeamChatNotificationPanel({ isOpen, onClose }: TeamChatNotificationPanelProps) {
  const { 
    notifications, 
    unreadCount, 
    markAsRead, 
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-end pt-16 pr-4">
      ...
      <div className="relative bg-gray-800 border border-gray-700 rounded-lg shadow-xl w-96 max-h-[80vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {isEnabled && filteredNotifications.map((notification) => (
            <div
              key={notification.id}
