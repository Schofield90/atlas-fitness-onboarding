  ...
  const insertVariable = (variable: string) => {
    const textarea =
      typeof document !== "undefined"
        ? (document.getElementById("sms-message") as HTMLTextAreaElement)
        : null;
    if (textarea) {
...
[organization_name] Team`;
  ...
  const sendTestSMS = async () => {
    ...
    try {
      ...
      let testMessage =
        message ||
        "Test SMS from [organization_name]. Your SMS integration is working correctly!";
      ...
      setTestResult({
        success: false,
        message:
          error.message || "An error occurred while sending the test SMS",
      });
    } finally {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="mt-1 flex items-center justify-between text-sm">
          <span
            className={`${getCharacterCount() > 160 ? "text-orange-600" : "text-gray-500"}`}
          >
      ...
      <div className="space-y-3">
        ...
        <label className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) =>
              handleSendingOptionChange("includeOptOut", e.target.checked)
            }
        ...
        <label className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) =>
              handleSendingOptionChange("trackDelivery", e.target.checked)
            }
            className="rounded border-gray-300 text-blue-600"
          />
          <span className="text-sm text-gray-700">Track delivery status</span>
        </label>
        ...
        <label className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) =>
              handleSendingOptionChange("fallbackToEmail", e.target.checked)
            }
            className="rounded border-gray-300 text-blue-600"
          />
          <span className="text-sm text-gray-700">
        ...
        <div className="p-3 bg-orange-50 rounded-lg">
          <div className="flex items-start">
            ...
            <div className="text-sm text-orange-800">
              ...
              <p>
                Your message exceeds 160 characters and will be sent as{" "}
                {getSMSCount()} separate SMS messages, which may increase costs.
              </p>
            </div>
          </div>
        </div>
