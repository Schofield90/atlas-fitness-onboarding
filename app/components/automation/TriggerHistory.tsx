              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-sm px-2 py-1 rounded-full ${getStatusColor(selectedExecution.status)}`}
                    >
                          ...
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm font-medium text-white">
                                Step {index + 1}:{" "}
                                {step.action_type || step.node_type}
                              </span>
                            </div>
                            <span
                              className={`text-xs px-2 py-1 rounded-full ${getStatusColor(step.status)}`}
                            >
                              {step.status}
                            </span>
                          </div>
