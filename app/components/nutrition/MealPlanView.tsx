    ...
    <div className="p-6">
      ...
      {!currentPlan ? (
        ...
        <div className="space-y-6">
          ...
          {currentPlan.meal_data &&
            currentPlan.meal_data[`day_${selectedDay}`] && (
              <div className="space-y-4">
                ...
                {/* Meals */}
                {currentPlan.meal_data[`day_${selectedDay}`].meals?.map(
                    ...
                    <div key={index} className="bg-gray-800 rounded-lg p-4">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="flex gap-2">
                          <button
                            onClick={() =>
                              handleMealFeedback(`${day}-${index}`, "like")
                            }
                          ...
                          <button
                            onClick={() =>
                              handleMealFeedback(`${day}-${index}`, "dislike")
                            }
          ...
          {currentPlan.meal_prep_tips &&
            currentPlan.meal_prep_tips.length > 0 && (
              <div className="bg-gray-800 rounded-lg p-4">
                ...
                <ul className="text-gray-400 space-y-2">
                  {currentPlan.meal_prep_tips.map(
