...
const ComponentRenderer: React.FC<{ component: Component }> = ({ component }) => {
  ...
  switch (type) {
    ...
    case COMPONENT_TYPES.HERO:
      return <Components.HeroComponent {...props} />
    case COMPONENT_TYPES.TEXT:
      return <Components.TextComponent {...props} />
  ...
  const componentGroups = [
    ...
    },
    {
      ...
      components: [
        ...
        { type: COMPONENT_TYPES.TESTIMONIALS, icon: Square, label: 'Testimonials' },
...
}> = ({ onUndo, onRedo, canUndo, canRedo, onSave, onPublish, onToggleLibrary, onToggleProperties }) => {
  return (
  ...
  return (
    <div className="w-80 bg-white border-l border-gray-200 overflow-y-auto">
      ...
      <div className="p-4">
        <ComponentProperties 
          component={component}
          onUpdate={(props) => onUpdate({ props: { ...component.props, ...props } })}
        />
      </div>
    </div>
  )
    ...
    <div className="flex flex-col items-center justify-center h-full min-h-[400px]">
      <div className="text-center">
        ...
        <p className="text-gray-500 mb-6">
          Drag and drop components from the sidebar or click below to get started
        </p>
  ...
  switch (type) {
    ...
    case COMPONENT_TYPES.HERO:
      return {
        ...
        description: 'Create beautiful landing pages with our drag and drop builder',
    ...
    case COMPONENT_TYPES.CTA:
      return {
        ...
        primaryButton: { label: 'Start Now', href: '#' }
      }
    default:
      return {}
  }
