...
export default function TwilioSetupWizard({ 
  ...
  const copyToClipboard = async (text: string, field: string) => {
    const success = await import('@/app/lib/utils').then(utils => utils.copyToClipboard(text))
    if (success) {
  ...
  const steps: Step[] = [
      ...
      component: (
        <div className="space-y-6">
          <div className="bg-gray-900 rounded-lg p-6">
            <h4 className="text-lg font-semibold text-white mb-4">Step 1: Create Your Account</h4>
            ...
            <div className="mt-6 p-4 bg-green-900/20 border border-green-500/20 rounded-lg">
              ...
              <p className="text-green-300 text-sm">
                New accounts receive <strong>$15 in free credits</strong> to test SMS and voice features.
    ...
    },
    {
      ...
      isComplete: !!(settings?.config?.account_sid && settings?.config?.auth_token),
      component: (
        <div className="space-y-6">
          <div className="bg-gray-900 rounded-lg p-6">
            <h4 className="text-lg font-semibold text-white mb-4">Step 2: Find Your Credentials</h4>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-gray-300">
                  <p className="mb-2">Look for the <strong>"Account Info"</strong> section on the main dashboard</p>
                  <p className="text-sm text-gray-400">This will be in the top right area of your console</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-gray-300">
                  ...
                  <ul className="list-disc list-inside text-sm space-y-1 ml-4">
                    <li><strong>Account SID</strong> - starts with "AC" (always visible)</li>
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            <h5 className="font-medium text-white mb-4">Enter Your Credentials</h5>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  {settings?.config?.account_sid && (
                    <button
                      onClick={() => copyToClipboard(settings.config.account_sid, 'account_sid')}
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
                    {settings?.config?.auth_token && (
                      <button
                        onClick={() => copyToClipboard(settings.config.auth_token, 'auth_token')}
    ...
    },
    {
      ...
      component: (
        <div className="space-y-6">
          <div className="bg-gray-900 rounded-lg p-6">
            <h4 className="text-lg font-semibold text-white mb-4">Step 3: Buy a Phone Number</h4>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-gray-300 mb-2">
                    In your Twilio Console, navigate to <strong>Phone Numbers → Manage</strong>
                  </p>
                  <a 
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-gray-300">
                  <p className="mb-2">Click <strong>"Buy a number"</strong></p>
                  <p className="text-sm text-gray-400">You'll need at least $1 in account credits</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-gray-300">
                  ...
                  <ul className="list-disc list-inside text-sm space-y-1 ml-4">
                    ...
                    <li>Choose <strong>SMS</strong> capability</li>
                    <li>Optionally select <strong>Voice</strong> for calls</li>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-gray-300">
                  <p>Click <strong>"Buy"</strong> on your preferred number</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-blue-900/20 border border-blue-500/20 rounded-lg">
              ...
              <p className="text-blue-300 text-sm">
                Make sure to select a number with <strong>SMS capabilities</strong>. 
                Voice is optional but recommended for full communication features.
              </p>
            </div>
          </div>
          ...
          {/* Phone Number Input */}
          <div className="bg-gray-800 rounded-lg p-6">
            <h5 className="font-medium text-white mb-4">Enter Your Phone Number</h5>
            ...
            <div>
              ...
              <div className="relative">
                ...
                {settings?.config?.phone_number && (
                  <button
                    onClick={() => copyToClipboard(settings.config.phone_number, 'phone_number')}
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-300"
                  >
            ...
            {settings?.config?.available_numbers && settings.config.available_numbers.length > 0 && (
              <div className="mt-4">
                <h6 className="text-sm font-medium text-gray-400 mb-2">Available Numbers:</h6>
                <div className="grid grid-cols-1 gap-2">
                  {settings.config.available_numbers.map((number: any, index: number) => (
                    <button
                      key={index}
                      onClick={() => handleChange('phone_number', number.phoneNumber)}
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-400">
                        {number.capabilities.join(', ')} • ${number.monthlyPrice}/month
                      </div>
                    </button>
                  ))}
                </div>
    ...
    },
    {
      ...
      component: (
        <div className="space-y-6">
          <div className="bg-gray-900 rounded-lg p-6">
            <h4 className="text-lg font-semibold text-white mb-4">Step 4: Test & Final Setup</h4>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4">
                <button
                  onClick={onTestConnection}
                  disabled={testingConnection || !settings?.config?.account_sid || !settings?.config?.auth_token}
                ...
                <div className="flex items-center gap-2">
                  ...
                  {connectionStatus === 'testing' && (
                    <>
                      ...
                      <span className="text-yellow-500 font-medium">Testing...</span>
                    </>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-4">
              <h5 className="font-medium text-white">Webhook Configuration (Optional)</h5>
              <p className="text-gray-400 text-sm">
                Webhooks allow Twilio to notify your app about message delivery and incoming messages.
              </p>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleChange('status_callback_url', e.target.value)}
            ...
            {connectionStatus === 'success' && (
              <div className="mt-6 p-4 bg-green-900/20 border border-green-500/20 rounded-lg">
                ...
                <p className="text-green-300 text-sm">
                  Your Twilio integration is ready to use. You can now send SMS messages and receive webhooks.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-3 text-sm text-gray-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>Configure your phone number</strong> in Twilio Console to use your webhook URLs
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <strong>Set up message templates</strong> for automated communications
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <strong>Test sending messages</strong> using the SMS test panel
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <strong>Monitor usage and billing</strong> in your Twilio Console
                </div>
              </div>
            </div>
          </div>
  ...
  const canProceedToNext = () => {
    ...
    switch (currentStepData.id) {
      ...
      case 'credentials':
        return !!(settings?.config?.account_sid && settings?.config?.auth_token)
      case 'phone-number':
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-6">
      ...
      {/* Step Title */}
      <div className="mb-6">
        <h4 className="text-xl font-semibold text-white">{steps[currentStep].title}</h4>
