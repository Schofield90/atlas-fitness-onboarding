        ...
        setMetrics([
          {
            ...
            details: data.databaseLatency ? `${data.databaseLatency}ms latency` : undefined
          },
          {
            name: 'Stripe API',
            status: data.stripe ? 'healthy' : 'warning',
            value: data.stripe ? 'Connected' : 'Issues detected',
            details: data.stripeWebhooks ? `${data.stripeWebhooks} webhooks pending` : undefined
          },
          {
            name: 'GoCardless',
          ...
          },
          {
            ...
            details: data.emailQueue ? `${data.emailQueue} emails queued` : undefined
          }
        ])
      }
    } catch (error) {
