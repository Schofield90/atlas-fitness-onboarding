...
export default function ImpersonationControls({ organizationId, organizationName }: ImpersonationControlsProps) {
            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3">
                <p className="text-sm text-yellow-800">
                  <strong>Warning:</strong> All actions will be logged and audited. 
                  This session will automatically expire after the selected duration.
                </p>
              </div>
            </div>
