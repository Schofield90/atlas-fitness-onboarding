            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-300 font-mono">{organization.id}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              {users.length === 0 ? (
                ...
                <div className="space-y-4">
                  {users.map((userOrg) => (
                    <div key={userOrg.id} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg">
                    ...
                    <div key={lead.id} className="p-4 bg-gray-700 rounded-lg">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-400">{lead.email || 'No email'}</p>
                        </div>
      ...
      case 'billing':
        return (
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <p className="text-gray-400">Billing details and subscription management coming soon.</p>
          </div>
        )
      ...
      case 'settings':
        return (
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <p className="text-gray-400">Organization configuration and preferences coming soon.</p>
          </div>
        )
