        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              placeholder="Search..."
              className="px-3 py-1 border border-gray-600 bg-gray-900 text-white rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-orange-500"
            />
            <select
              value={statusFilter}
              ...
              <tr key={org.id} className="hover:bg-gray-750">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span
                    ...
                    ${org.subscription_status === "active" ? "bg-green-900 text-green-200" : ""}
                    ${org.subscription_status === "trialing" ? "bg-blue-900 text-blue-200" : ""}
                    ${org.subscription_status === "past_due" ? "bg-red-900 text-red-200" : ""}
                    ${org.subscription_status === "canceled" ? "bg-gray-700 text-gray-300" : ""}
                  `}
                  >
                    {org.subscription_status}
                  </span>
