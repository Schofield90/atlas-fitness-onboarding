    ...
    try {
      ...
      const response = await fetch("/api/client-portal/claim", {
        ...
        body: JSON.stringify({
          ...
          password: password,
          clientName:
            portalAccess.clients.name ||
            `${portalAccess.clients.first_name} ${portalAccess.clients.last_name}`,
        }),
      });
      ...
      // Redirect to appropriate client dashboard based on current domain
      const hostname =
        typeof window !== "undefined" ? window.location.hostname : "";
      const isOnMembersSubdomain =
        hostname.includes("members.gymleadhub.co.uk") ||
        hostname.includes("members.localhost");
          ...
          <button
            onClick={() => {
              ...
              if (isOnMembersSubdomain) {
                ...
                const membersUrl = hostname.includes("localhost")
                  ? "http://members.localhost:3000/simple-login"
        ...
        <div className="bg-white rounded-lg shadow p-8">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">
              Claim Your Portal Access
            </h2>
            <p className="mt-2 text-gray-600">
              Welcome {portalAccess?.clients.first_name}! Set up your password
