...
describe("Migrations upload interactions", () => {
  beforeAll(() => {
    // jsdom doesn't implement DataTransfer fully; provide a minimal shim if needed
  });
  ...
  it("advances to step 2 when clicking to upload and selecting a file", async () => {
    ...
    // Find the hidden input via role is not possible; query by testid on container and then input
