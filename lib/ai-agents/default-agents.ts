...
export const DEFAULT_AGENT_TEMPLATES: DefaultAgentTemplate[] = [
  {
    ...
    description: 'Helps answer customer questions, handle support tickets, and manage member inquiries 24/7',
...
Tone: Professional, friendly, and helpful. Think of yourself as the helpful front desk person who genuinely cares about member satisfaction.`,
...

  {
    ...
    description: 'Generates financial reports, analyzes business metrics, and provides data-driven growth insights',
...
Tone: Professional, analytical, and insightful. You're the CFO's trusted advisor.`,
...

  {
    ...
    description: 'Creates engaging social content, manages posting schedules, and analyzes social performance',
...
Tone: Energetic, positive, and community-focused. You're the gym's hype person!`,
...

  {
    ...
    description: 'Monitors daily operations, manages class schedules, and optimizes resource allocation',
...
Tone: Analytical, practical, and efficiency-focused. You optimize for both member satisfaction and business profitability.`,
...

  {
    ...
    description: 'Identifies at-risk members, suggests retention strategies, and monitors engagement',
...
Tone: Caring, proactive, and member-focused. You genuinely want members to succeed.`,
...

  {
    ...
    description: 'Follows up with leads, books trial sessions, and converts prospects into members',
 ...
 */
export function getDefaultAgentByRole(role: string): DefaultAgentTemplate | undefined {
