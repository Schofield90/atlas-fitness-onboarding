...
import { ArrowLeft, Plus, Eye, Save, Settings, Smartphone, Monitor, Tablet, Trash2 } from 'lucide-react'
...
export default function LandingPageBuilderEditPage() {
        ...
        elements: [
          {
            ...
            content: {
              title: 'Atlas Fitness',
              logo: null,
              navigation: ['Home', 'Programs', 'About', 'Contact']
            },
            styles: {}
          },
          {
            ...
            content: {
              ...
              subtitle: 'Join our proven fitness challenge and see real results',
              ctaText: 'Start Your Challenge',
  ...
  const renderElement = (element: PageElement) => {
    ...
    return (
      <div
        key={element.id}
        className={`relative border-2 ${isSelected ? 'border-blue-500' : 'border-gray-200'} rounded-lg p-4 mb-4 cursor-pointer hover:border-gray-300 transition-colors`}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateElementContent(element.id, { subtitle: e.target.value })}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateElementContent(element.id, { ctaText: e.target.value })}
              />
            </div>
          </div>
        )
        ...
        return (
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                value={element.content.submitText}
                onChange={(e) => updateElementContent(element.id, { submitText: e.target.value })}
              />
            </div>
          </div>
        )
        ...
        return (
          <div className="space-y-4">
            <div>
              <Label>Content</Label>
              <Textarea
                value={element.content.content.replace(/<[^>]*>/g, '')}
                onChange={(e) => updateElementContent(element.id, { content: `<p>${e.target.value}</p>` })}
                rows={6}
              />
            </div>
          </div>
  ...
  const handleSave = () => {
    ...
    console.log('Saving page data:', { ...pageData, elements })
      ...
      <div className="bg-white border-b px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-semibold">{pageData?.name}</h1>
              <p className="text-sm text-gray-600">{pageData?.description}</p>
            </div>
          </div>
