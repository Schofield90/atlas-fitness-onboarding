...
const ClassBlock: React.FC<ClassBlockProps> = ({
  ...
  const getColorClasses = (color: string) => {
    const colors = {
      orange:
        "bg-gradient-to-br from-orange-600/20 to-orange-700/30 border-orange-600/50 hover:from-orange-600/30 hover:to-orange-700/40",
      purple:
        "bg-gradient-to-br from-purple-600/20 to-purple-700/30 border-purple-600/50 hover:from-purple-600/30 hover:to-purple-700/40",
      blue: "bg-gradient-to-br from-blue-600/20 to-blue-700/30 border-blue-600/50 hover:from-blue-600/30 hover:to-blue-700/40",
      green:
        "bg-gradient-to-br from-green-600/20 to-green-700/30 border-green-600/50 hover:from-green-600/30 hover:to-green-700/40",
