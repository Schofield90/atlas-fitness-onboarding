    ...
    const allSources = [
      {
        id: "all",
        name: "All Sources",
        description: "Trigger for leads from any source",
      },
      {
        id: "website",
        name: "Website Form",
      ...
      },
      {
        id: "walk-in",
        name: "Walk-in",
        description: "In-person walk-in leads",
      },
      {
        id: "referral",
        name: "Referral",
      ...
      },
      {
        id: "phone",
        name: "Phone Call",
        description: "Leads from phone inquiries",
      },
      { id: "email", name: "Email", description: "Leads from email inquiries" },
      {
        id: "whatsapp",
        name: "WhatsApp",
        description: "Leads from WhatsApp messages",
      },
      {
        id: "google",
        name: "Google Ads",
