...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    logger.info(
      `Leads API (cached) - Org: ${userWithOrg.organizationId}, Response time: ${responseTime}ms`,
      {
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logger.info(
      `Lead created via cached API - Org: ${userWithOrg.organizationId}, Lead: ${leadId}, Response time: ${responseTime}ms`,
    );
...
export async function PATCH(request: NextRequest) {
  ...
  try {
    ...
    logger.info(
      `Lead updated via cached API - Lead: ${body.id}, Response time: ${responseTime}ms`,
    );
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    logger.warn(
      `Lead deletion not implemented in cached service - Lead: ${leadId}, invalidated cache instead`,
    );
